...
{
    public static string GenerateFilename(DevelopmentType devType)
    {
        List<string> extensions = devType switch
        {
            ...
            DevelopmentType.Blockchain => ["sol", "rs", "go", "js", "ts", "wasm", "move", "cairo", "vy", "cpp",],
            DevelopmentType.MachineLearning => ["py", "ipynb", "pth", "h5", "pb", "tflite", "onnx", "pt", "cpp", "cu",],
            DevelopmentType.SystemsProgramming => ["rs", "c", "cpp", "h", "hpp", "asm", "s", "go", "zig", "d"],
            DevelopmentType.GameDevelopment => ["cpp", "h", "cs", "js", "ts", "glsl", "hlsl", "shader", "unity", "prefab",],
        ...
        List<string> components = devType switch
        {
            DevelopmentType.Backend => [
                "Service",
                "Controller",
        ...
        List<string> domainPrefixes = devType switch
        {
            DevelopmentType.Backend => [
                "User",
                "Account",
        ...
        var prefix = domainPrefixes.RandomElement(0.66, components);
        var component = components.RandomElement();
        var extension = extensions.RandomElement();

        // Only use prefix if it's different from component
        return prefix == component ? $"{component}.{extension}" : $"{prefix}{component}.{extension}";
    }

    public static string GenerateCodeIssue(DevelopmentType devType)
    {
        ...
        List<string> specificIssues = devType switch
        {
            DevelopmentType.Backend => [
        ...
        return commonIssues.RandomElement(0.33, specificIssues);
    }

    public static string GenerateComplexityMetric()
    {
        List<string> complexityMetrics = [
        ...
        return complexityMetrics.RandomElement();
    }
}

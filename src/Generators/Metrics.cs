...
{
    public static string GenerateMetricUnit(DevelopmentType devType)
    {
        List<string> units = devType switch
        {
            ...
            DevelopmentType.Frontend => ["ms", "fps", "KB", "MB", "elements", "nodes", "req/s", "s", "μs", "%",],
            _ => ["ms", "s", "MB/s", "GB/s", "ops/s", "%", "MB", "KB", "count", "ratio",],
        };

        return units.RandomElement();
    }

    public static string GenerateOptimizationRecommendation(DevelopmentType devType)
    {
        List<string> recommendations = devType switch
        {
    ...
    public static string GeneratePerformanceMetric(DevelopmentType devType)
    {
        List<string> metrics = devType switch
        {
            DevelopmentType.Backend => [
                "API Response Time",
